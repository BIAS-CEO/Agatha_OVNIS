        ...
        if caso_sel:
            ...
            if st.button("Ejecutar Analisis de Inteligencia (DeepSeek)", type="primary"):
                if DEEPSEEK_API_KEY:
                    ...
                    st.warning("Falta credencial DEEPSEEK_API_KEY en configuración del sistema.")[data-testid="stHeader"], footer, [data-testid="collapsedControl"] { display: none !important; }
.block-container { 
    padding-top: 2rem !important; 
    padding-bottom: 2rem !important; 
    max-width: 98% !important; 
